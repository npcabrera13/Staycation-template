    ...
    <footer className="bg-secondary text-white pt-12 pb-6" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Brand */}
          <div>
            <h3 className="font-serif text-2xl font-bold mb-4">Serenity Staycation</h3>
            <p className="text-gray-300 text-sm leading-relaxed">
              Experience luxury, comfort, and nature combined. Your perfect escape is just a click away.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              ...
              <li className="flex space-x-4 mt-4">
                <a href={`https://${COMPANY_INFO.facebook}`} target="_blank" rel="noreferrer" className="hover:text-blue-400 transition"><Facebook /></a>
                <a href={`https://${COMPANY_INFO.instagram}`} target="_blank" rel="noreferrer" className="hover:text-pink-400 transition"><Instagram /></a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center text-xs text-gray-400">
          &copy; {new Date().getFullYear()} Serenity Staycation. All rights reserved.
        </div>
      </div>
    </footer>
  );
