    ...
    <div className="fixed bottom-6 right-6 z-40">
      {!isOpen && (
        <button
          ...
          className="bg-primary text-white p-4 rounded-full shadow-lg hover:bg-primary-hover transition-transform transform hover:scale-110 flex items-center justify-center"
        >
      ...
      {isOpen && (
        <div className="bg-white w-80 sm:w-96 h-[450px] rounded-lg shadow-2xl flex flex-col overflow-hidden border border-gray-200">
          ...
          <div className="bg-primary p-4 flex justify-between items-center text-white">
            ...
            <button onClick={() => setIsOpen(false)} className="hover:bg-primary-hover rounded p-1">
              <X size={20} />
            </button>
          </div>
