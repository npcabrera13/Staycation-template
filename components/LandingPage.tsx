...
const LAYOUT_CONFIGS = {
    'mosaic': {
        name: 'Classic Mosaic',
        gridClass: 'grid-cols-2 grid-rows-2 gap-2 md:gap-4',
        wrapperClass: 'h-80 sm:h-[400px] md:h-[550px] xl:h-[600px]',
        frames: [
            { className: 'col-span-1 row-span-2 h-full' },
            { className: 'col-span-1 row-span-1 h-full' },
            { className: 'col-span-1 row-span-1 h-full' },
        ],
        icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="8" height="18" rx="2" /><rect x="13" y="3" width="8" height="8" rx="2" /><rect x="13" y="13" width="8" height="8" rx="2" /></svg>
    },
    'grid-2': {
        name: '2-Column Split',
        gridClass: 'grid-cols-2 grid-rows-1 gap-2 md:gap-4',
        wrapperClass: 'h-64 sm:h-80 md:h-[450px] xl:h-[500px]',
        frames: [
            { className: 'col-span-1 h-full' },
            { className: 'col-span-1 h-full' },
        ],
        icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="8" height="16" rx="2" /><rect x="13" y="4" width="8" height="16" rx="2" /></svg>
    },
    'grid-3': {
        name: '3-Column Row',
        gridClass: 'grid-cols-3 gap-2 md:gap-4',
        wrapperClass: 'h-auto',
        frames: [
            { className: 'h-40 sm:h-56 md:h-[400px] xl:h-[480px]' },
            { className: 'h-40 sm:h-56 md:h-[400px] xl:h-[480px]' },
            { className: 'h-40 sm:h-56 md:h-[400px] xl:h-[480px]' },
        ],
        icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="6" width="5" height="12" rx="1.5" /><rect x="9.5" y="6" width="5" height="12" rx="1.5" /><rect x="17" y="6" width="5" height="12" rx="1.5" /></svg>
    },
    'grid-4': {
        name: '2x2 Grid',
        gridClass: 'grid-cols-2 grid-rows-2 gap-2 md:gap-4',
        ...
        icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="4" width="6" height="6" rx="1.5" /><rect x="14" y="4" width="6" height="6" rx="1.5" /><rect x="4" y="14" width="6" height="6" rx="1.5" /><rect x="14" y="14" width="6" height="6" rx="1.5" /></svg>
    },
    'panorama': {
        ...
        wrapperClass: 'h-auto',
        frames: [
            { className: 'col-span-2 row-span-1 h-48 sm:h-64 md:h-80' },
            { className: 'col-span-1 row-span-1 h-32 sm:h-48 md:h-56' },
            { className: 'col-span-1 row-span-1 h-32 sm:h-48 md:h-56' },
        ],
        icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="8" rx="2" /><rect x="3" y="13" width="8" height="8" rx="2" /><rect x="13" y="13" width="8" height="8" rx="2" /></svg>
    }
};
...
const LandingPage: React.FC<LandingPageProps> = ({
    ...
    useEffect(() => {
        ...
        if (hash) {
            ...
            console.log("Auto-scrolling to target:", targetId);
            ...
            }, 800); // Wait slightly longer for layout to settle
                ...
                <section id="about" className="py-24 md:py-32 bg-white dark:bg-gray-800 scroll-mt-20 overflow-visible relative">
                    <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-16">
                        ...
                        {(() => {
                            ...
                            return (
                                <div className={`md:w-1/2 relative w-full ${layout.wrapperClass || 'h-80 md:h-[600px]'} order-1 md:order-2`}>
                                    <RevealOnScroll delay={300} className="h-full w-full">
                                        ...
                                        <div 
                                            className={`relative w-full h-full grid group ${layout.gridClass} ${!layout.gridClass.includes('gap') ? 'gap-3 md:gap-4' : ''}`}
                                        >
                                    ...
                                    <div className="pt-2">
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
                                            {Object.entries(LAYOUT_CONFIGS).map(([key, config]) => (
                                                ...
                                                >
                                                    <div className={`w-8 h-8 rounded border-2 border-dashed ${tempLayoutType === key ? 'border-primary text-primary' : 'border-gray-300 dark:border-gray-600 text-gray-400'} flex items-center justify-center`}>
                                                        {config.icon || <Layout size={14} />}
                                                    </div>
